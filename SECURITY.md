...
You should receive an acknowledgment within 7 days. The maintainer will
review the report, ask follow-up questions if needed, and coordinate a
fix and release timeline based on severity.
...
- disclosure of local paths, credentials, tokens, or private package
  names.

Reports about missing system packages or ordinary installation failures
should use the issue templates instead.
